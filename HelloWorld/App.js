...
import {StyleSheet, Text, View, Vibration, Alert, Linking, Button, Image } from 'react-native';
		...
		return (
			<View style={styles.container}>
				...
				<Card title="Custom Apps by Indasys" style={[{color: '#009', justifyContent: 'center', alignItems: 'center'}]}>
					<Text>
						Indasys is a customer software and app devloper with locations in Saint Petersburg, FL, and New York, NY.
